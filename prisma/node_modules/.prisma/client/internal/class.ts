...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Administrador\\Desktop\\projects\\skai\\prisma\\node_modules\\.prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Administrador\\Desktop\\projects\\skai\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "../../..",
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client\"\n  output   = \"./node_modules/.prisma/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id            String          @id @default(cuid())\n  name          String?\n  email         String          @unique\n  emailVerified DateTime?\n  image         String?\n  accounts      Account[]\n  sessions      Session[]\n  skinProfile   SkinProfile?\n  Authenticator Authenticator[]\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Account {\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String?\n  access_token      String?\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String?\n  session_state     String?\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@id([provider, providerAccountId])\n}\n\nmodel Session {\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n  user         User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel VerificationToken {\n  identifier String\n  token      String\n  expires    DateTime\n\n  @@id([identifier, token])\n}\n\n// Optional for WebAuthn support\nmodel Authenticator {\n  credentialID         String  @unique\n  userId               String\n  providerAccountId    String\n  credentialPublicKey  String\n  counter              Int\n  credentialDeviceType String\n  credentialBackedUp   Boolean\n  transports           String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@id([userId, credentialID])\n}\n\n// ADICIONE ESTE MODELO\nmodel SkinProfile {\n  id          String   @id @default(cuid())\n  userId      String   @unique // Garante que cada usuário tenha apenas um perfil\n  user        User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n  skinType    SkinType\n  concerns    String[] // Armazena um array de preocupações, ex: [\"acne\", \"aging\"]\n  sensitivity String // Pode ser \"low\", \"medium\", \"high\" ou uma descrição\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nenum SkinType {\n  OILY\n  DRY\n  COMBINATION\n  NORMAL\n  SENSITIVE\n}\n",
  "inlineSchemaHash": "02905fe2047635596714b89b4203d4ad38079e54bf68100f4998ed13a31546b8",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
...
/**
  ...
  /**
   * `prisma.skinProfile`: Exposes CRUD operations for the **SkinProfile** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more SkinProfiles
    * const skinProfiles = await prisma.skinProfile.findMany()
    * ```
    */
  get skinProfile(): Prisma.SkinProfileDelegate<ExtArgs, { omit: OmitOpts }>;
}
